...
class Settings(BaseSettings):
    ...
    app_description: str = Field(
        default="Catalog service built with FastAPI following hexagonal architecture"
    )
    app_version: str = Field(default="1.0.0")
    app_contact_name: str = Field(default="Your Name")
    docs_url: str = Field(default="/catalog/docs")
    redoc_url: str = Field(default="/catalog/redoc")
    openapi_url: str = Field(default="/catalog/openapi.json")
